  ...
  return (
    <>
      ...
      <div className="mx-32 my-10 p-4 bg-white">
        ...
        {/* container */}
        <div className="flex my-4 pr-10 pl-8 justify-between">
          {/* buttons */}
            ...
            <div className=" min-w-36">
              <Listbox value={selected} onChange={setSelected}>
                <div className="relative z-50 w-full">
                  <Listbox.Button className="relative w-full cursor-default text-gray-400 bg-white py-2 pl-3 pr-10 text-left  ring-1 ring-gray-300 focus:outline-none focus-visible:border-indigo-500 focus-visible:ring-2 focus-visible:ring-white/75 focus-visible:ring-offset-2 focus-visible:ring-offset-blue-300 sm:text-sm">
                  ...
                  <Transition
                    ...
                    leaveTo="opacity-0"
                  >
                    <Listbox.Options className="absolute mt-1 max-h-60 w-full overflow-auto  bg-white  text-base shadow-lg ring-1 ring-black/5 focus:outline-none sm:text-sm">
