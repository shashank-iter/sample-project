  ...
  return (
    <>
     <div className="absolute top-0 left-0 w-full h-full -z-10 bg-[#f5faff]">
      ...
      <div className="mx-4 sm:mx-auto max-w-3xl my-8">
        <h1 className="inline-flex justify-center items-center mt-10 ">
          <span className="text-3xl font-semibold">Data Lakehouse</span>
      ...
      <div className=" mx-4 md:mx-auto md:my-10 p-4 bg-white max-w-3xl">
        {/* header */}
        ...
        <div className="flex my-4 justify-between flex-wrap gap-4 px-4">
          ...
          <div className="flex gap-4 justify-center items-center">
            {/* select */}
            <div className=" min-w-36 flex flex-row flex-wrap">
                      ...
                      {people.map((person, personIdx) => (
                        <Listbox.Option
                          ...
                          ${
                            active &&
                            !selected &&
                            "transition duration-200 ring-1 ring-[#2e5ce5]"
                          }
          ...
          <div className="flex gap-4 justify-center items-center">
            {/* volume */}
            <div className="flex flex-col justify-center items-center gap-1 my-2 sm:my-0">
              <span className="text-xl sm:text-3xl md:text-4xl font-bold sm:font-semibold text-blue-600">
                9.9K
              </span>
            ...
            <div className="flex flex-col justify-center items-center gap-1">
              <span className="text-xl sm:text-3xl md:text-4xl font-bold sm:font-semibold text-green-500">
                7.6K
              </span>
              <span className="text-xs text-gray-400 flex gap-1">
                Growth
